  ...
  return (
    <div className="bg-white shadow-md border border-gray-200 rounded-lg max-w-sm">
      ...
      <div className="p-5">
        ...
        {buttonText && link &&
          <a className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center inline-flex items-center" href={link}>
            {buttonText}
          </a>
        }
      </div>
