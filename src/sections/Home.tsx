        ...
        <div className="bg-[url('./assets/space.webp')] bg-cover bg-fixed mt-[32px]">
            <div className="bg-black bg-opacity-80 flex flex-col items-center justify-center text-center h-[calc(100vh-32px)] lg:flex-row">
                ...
                <div className="text-white">
                    <h1 className="relative mt-1 px-10 text-3xl font-extrabold  group-hover:scale-[1.005] duration-100 ease-in cursor-pointer sm:text-4xl sm:px-3">Maximiliano Ponce Marquez</h1>
                    <div className="relative group mt-4 inline-block">
                        ...
                        <p className="relative bg-neutral-900 rounded-lg px-5 ">
